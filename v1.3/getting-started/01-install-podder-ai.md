...
- [Linux 64bit](https://podder-ai-downloads.s3-ap-southeast-1.amazonaws.com/podder-installer/1.3.3/podder-installer-1.3.3_linux_amd64)
...
$ chmod 755 podder-installer-1.3.3_linux_amd64

# Execute podder-installer
$ sudo ./podder-installer-1.3.3_linux_amd64
```
